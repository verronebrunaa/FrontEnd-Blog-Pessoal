...
function CadastroUsuario() {
    ...
    async function onSubmit(e: ChangeEvent<HTMLFormElement>) {
        e.preventDefault()
        if (confirmarSenha == user.senha && user.usuario.includes('@')) {
            ...
            toast.error('Dados do usuário inconsistentes. Erro ao cadastrar usuário!', {
                position: "top-right",
                autoClose: 2000,
                hideProgressBar: false,
                closeOnClick: true,
    ...
    return (
        <Grid container direction='row' justifyContent='center' alignItems='center' className="backcadastro">
