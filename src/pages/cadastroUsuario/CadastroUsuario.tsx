            ...
            <Grid item xs={6} alignItems='center'>
                <Box paddingX={10}>
                    <form onSubmit={onSubmit}>
                        ...
                        <TextField value={user.confirmarSenha} onChange={(e: ChangeEvent<HTMLFormElement>) => confirmarSenhaHandle(e)} id='confirmarSenha' label='confirmarSenha' variant='outlined' name='confirmarSenha' margin='normal' type='password' fullWidth />
                        <Box marginTop={2} textAlign='center'>
                            ...
                            <Button type='submit' variant='contained' className='botao3'>
                                Cadastrar
                            </Button>
                        </Box>
                    </form>
